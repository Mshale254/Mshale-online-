...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .btn{background:linear-gradient(90deg,var(--accent1),var(--accent2));color:#012029;padding:10px 14px;border-radius:10px;text-decoration:none;font-weight:600;transition:0.3s}
